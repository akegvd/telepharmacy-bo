...
import { NormalizedServiceType } from "../types/task";

const ICONS: Record<NormalizedServiceType, typeof VideocamOutlinedIcon> = {
...
export function ServiceTypeIcon({
  serviceType,
  ...props
}: { serviceType: NormalizedServiceType } & SvgIconProps) {
